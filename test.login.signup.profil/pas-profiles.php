      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div style="color:#B959B5 ; text-align: center;" class="container ">
        <div class="col-sm-12 justify-content-center mt-4  pb-2 ">
           <h1>  Vous êtes déjà dans un groupe</h1>
        </div>
             </div>

              </div>
            <img src="assets/images/faces/Design sans titre.svg" >
