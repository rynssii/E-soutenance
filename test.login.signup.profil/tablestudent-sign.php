...
// Récupérer les utilisateurs de type "etudiant"
try {
    $sql = "SELECT * FROM users WHERE typeuser = 'etudiant'";
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="page-header">
            <h1 class="text-center"style="color:#B959B5 ;">Liste des étudiants</h1>
            </div>
        ...
        <tbody>
            <?php foreach ($etudiants as $etudiant): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($etudiant['fname']); ?></td>
                    <td><?php echo htmlspecialchars($etudiant['pname']); ?></td>
                    <td><?php echo htmlspecialchars($etudiant['email']); ?></td>
                    <td><?php echo htmlspecialchars($etudiant['fac']); ?></td>
                    <td><?php echo htmlspecialchars($etudiant['special']); ?></td>
